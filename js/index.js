...
function add_navbar_item(name, link, icon, color) {
  ...
  let navbar_inside =
    ...
    <a href="`+link+`"><i class="`+icon+`"></i>`+name+`</a>
    </div>`;

  navbar.insertAdjacentHTML("beforeend", navbar_inside);
}
function add_card(card, card_text, card_link, card_desc,card_class) {
  let Card = document.getElementById(card);
  let card_inside =`
  <div class="body-card-text">
   <a href="`+card_link+`" class=" contrast">
...
add_card(
  ...
  "Emir Ozturk",
  "#",
  "IEU Computer programming student in turkey."
);

add_card("about-card","for cv","/cv_13122022.pdf","click here","cv-link");
...
add_card(
  ...
  "steam inspired website for midterm made by mostly me"
);
add_card(
  "projects-card",
  "java media player",
  "https://github.com/rimexe0/java-media-player",
  "This contains my frustration with javaFx and bearly working java code."
);
add_card(
  "projects-card",
  "gameshop",
  "https://github.com/rimexe0/gameshop",
  "steam inspired game store app for my midterm"
);
add_card(
  "projects-card",
  "oasis scraper",
  "https://github.com/rimexe0/oasis-scraper",
  "Simple program that gets oasis weekly schedule and sends it to google calendar"
);
...
add_card(
  ...
  "work in progress",
  "/mdread.html",
  "this part is going to be the blog part where i post about stuff i make. But its not ready yet."
);
